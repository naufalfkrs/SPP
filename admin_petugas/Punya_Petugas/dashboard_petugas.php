<?php
session_start();
if($_SESSION['status_login1']!=true){
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="dashboard_petugas.php"><img src="../Asset/assets/images/logo-mini.svg" alt="logo" /></a>
          </div>
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8 p-0">
                        ...
                        <p class="mb-0 font-weight-normal d-none d-sm-block"><?=$_SESSION['nama_petugas']?></p>
                      </div>
