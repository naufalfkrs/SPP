        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Data Angkatan </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Tables</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Data Angkatan</li>
                </ol>
              </nav>
            </div>
                    ...
                    <button type="button" class="btn btn-inverse-primary" data-toggle="modal" data-target="#exampleModalCenter" >+ Add</button>
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <?php
                              include "../koneksi.php";
                              $qry_siswa=mysqli_query($conn,"select * from angkatan ");
                              $no=0;
                              while($data_siswa=mysqli_fetch_array($qry_siswa)){
                              $no++;?>
                          <tr>
                            <td style="text-align:center;"><?=$no?></td>
                            <td style="text-align:center;"><?=$data_siswa['angkatan']?></td>
                            <td style="text-align:center;"><?=$data_siswa['tahun_angkatan']?></td>
                            <td style="text-align:center;"><a href="" class="btn btn-inverse-success mdi mdi-pencil" data-toggle="modal" data-target="#update<?php echo $data_siswa['id_angkatan'];?>"></a> <a href="hapus_angkatan.php?id_angkatan=<?=$data_siswa['id_angkatan']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-inverse-danger mdi mdi-delete"></a>
                            </td>

                            <!-- Modal Update -->
                            <div class="modal fade" id="update<?php echo $data_siswa['id_angkatan'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div style="background-color: #191c24;" class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Update Angkatan</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body">
                                  <form class="forms-sample" action="proses_ubah_angkatan.php" method="post">
                                  <input type="hidden" name="id_angkatan" class="form-control" id="exampleInputEmail1" value= "<?=$data_siswa['id_angkatan']?>">
                                    <div class="form-group">
                                      <label for="exampleSelectGender">Angkatan</label>
                                      <input type="number" name="angkatan" class="form-control" id="exampleInputEmail1" placeholder="Angkatan" value= "<?=$data_siswa['angkatan']?>" style="background-color:rgba(42,48,56,0.2);" disabled>
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputEmail1">Tahun</label>
                                      <input type="number" name="tahun_angkatan" class="form-control" id="exampleInputEmail1" placeholder="Tahun" value= "<?=$data_siswa['tahun_angkatan']?>">
                                    </div>
                        ...
                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div style="background-color: #191c24;" class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Tambah Angkatan</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                              <form class="forms-sample" action="proses_tambah_angkatan.php" method="post">
                                <div class="form-group">
                                  <label for="exampleSelectGender">Angkatan</label>
                                  <input type="number" name="angkatan" class="form-control" id="exampleInputEmail1" placeholder="Angkatan">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Tahun</label>
                                  <input type="number" name="tahun_angkatan" class="form-control" id="exampleInputEmail1" placeholder="Tahun">
                                </div>
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-dark" data-dismiss="modal">Close</button>
                                  <button type="submit" class="btn btn-primary">Submit</button>
