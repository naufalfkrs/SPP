                    ...
                    <button type="button" class="btn btn-inverse-primary" data-toggle="modal" data-target="#exampleModalCenter" >+ Add</button>
                      <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                              include "../koneksi.php";
                              $qry_siswa=mysqli_query($conn,"select * from kelas join angkatan on kelas.id_angkatan=angkatan.id_angkatan");
                              $no=0;
                          ...
                          <tr>
                            ...
                            <td style="text-align:center;"><?=$data_siswa['jurusan']?></td>
                            <td style="text-align:center;"><?=$data_siswa['angkatan']?></td>
                            <td style="text-align:center;"><a href="" class="btn btn-inverse-success mdi mdi-pencil" data-toggle="modal" data-target="#i<?php echo $data_siswa['id_kelas'];?>"></a> 
                            <a href="hapus_kelas.php?id_kelas=<?=$data_siswa['id_kelas']?>"              
                            onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-inverse-danger mdi mdi-delete"></a>
                            </td>

                            <!-- Modal Update -->
                            <div class="modal fade" id="i<?php echo $data_siswa['id_kelas'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div style="background-color: #191c24;" class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Update Kelas</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body">
                                  <form class="forms-sample" action="proses_ubah_kelas.php" method="post">
                                  <input type="hidden" name="id_kelas" class="form-control" id="exampleInputPassword1" value= "<?=$data_siswa['id_kelas']?>">
                                    <div class="form-group">
                                      <label for="exampleInputPassword1">Nama</label>
                                      <input type="text" name="nama_kelas" class="form-control" id="exampleInputPassword1" placeholder="Nama" value= "<?=$data_siswa['nama_kelas']?>" style="background-color:rgba(42,48,56,0.2);" disabled>
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputPassword1">Jurusan</label>
                                      <input type="text" name="jurusan" class="form-control" id="exampleInputPassword1" placeholder="Jurusan" value= "<?=$data_siswa['jurusan']?>">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div style="background-color: #191c24;" class="modal-content">
                              ...
                              <div class="modal-body">
                              <form class="forms-sample" action="proses_tambah_kelas.php" method="post">
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Nama</label>
                                  <input type="text" name="nama_kelas" class="form-control" id="exampleInputPassword1" placeholder="Nama">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Jurusan</label>
