                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td style="text-align:center;">Password Ter-enkripsi</td>
                            <td style="text-align:center;"><?=$data_siswa['level']?></td>
                            <td style="text-align:center;"><a href="" class="btn btn-inverse-success mdi mdi-pencil" data-toggle="modal" data-target="#u<?php echo $data_siswa['id_petugas'];?>"></a> 
                            <a href="hapus_petugas.php?id_petugas=<?=$data_siswa['id_petugas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-inverse-danger mdi mdi-delete"></a>
                            </td>
                            <!-- Modal Add-->
                        <div class="modal fade" id="u<?php echo $data_siswa['id_petugas'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div style="background-color: #191c24;" class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Update Petugas</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                              <form class="forms-sample" action="proses_ubah_petugas.php" method="post">
                              <input type="hidden" name="id_petugas" class="form-control" id="exampleInputPassword1" value="<?=$data_siswa['id_petugas']?>">
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Nama</label>
                                  <input type="text" name="nama_petugas" class="form-control" id="exampleInputPassword1" placeholder="Nama" value="<?=$data_siswa['nama_petugas']?>">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Username</label>
                                  <input type="text" name="username" class="form-control" id="exampleInputPassword1" placeholder="Username" value="<?=$data_siswa['username']?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  if($key_gender==$data_siswa['level']){
                                  $selek="selected";
                                  } else {
                                  $selek="";
                                  }
                        ...
                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div style="background-color: #191c24;" class="modal-content">
                              ...
                              <div class="modal-body">
                              <form class="forms-sample" action="proses_tambah_petugas.php" method="post">
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Nama</label>
                                  <input type="text" name="nama_petugas" class="form-control" id="exampleInputPassword1" placeholder="Nama">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Username</label>
