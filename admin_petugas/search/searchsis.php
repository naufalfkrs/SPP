                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                              include "../koneksi.php";
                              $no=0;
                              while($data_siswa=mysqli_fetch_array($his)){
                              $no++;
                                // while($dt_buku=mysqli_fetch_array($qry_siswa)){
                          ...
                          <tr>
                            ...
                            <a href="../siswa/hapus_siswa.php?nisn=<?=$data_siswa['nisn']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-inverse-danger mdi mdi-delete"></a>
                            </td>
                            <!-- Modal Update-->
                              ...
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div style="background-color: #191c24;" class="modal-content">
                                  ...
                                  <input type="hidden" name="id" class="form-control" id="exampleInputUsername1" value= "<?=$data_siswa['id']?>" >
                                    ...
                                    <div class="form-group">
                                      <label for="exampleSelectGender">ID Kelas</label>
