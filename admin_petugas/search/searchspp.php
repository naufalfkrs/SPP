          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                <form action="../search/searchspp.php" method="get" class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        ...
                        $bukti="<span class='tampil-gambar' data-src='../../siswa/bukti/$d[foto_bukti]' alt='foto bukti'>Lihat Foto</span>";
                            ...
                            $bayar="<a href='../Pembayaran/proses_transaksi.php?id_pembayaran=$d[id_pembayaran]&nisn=$d[nisn]'  class='btn btn-inverse-success'>Bayar</a>";
                            }
                        ?>
                          <tr>
