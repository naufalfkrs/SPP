                    ...
                    <button type="button" class="btn btn-inverse-primary" data-toggle="modal" data-target="#exampleModalCenter" >+ Add</button>
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <?php
                              include "../koneksi.php";
                              $qry_siswa=mysqli_query($conn,"select * from spp join angkatan on spp.id_angkatan=angkatan.id_angkatan");
                              $no=0;
                          ...
                          <tr>
                            ...
                            <td style="text-align:center;"><?=$data_siswa['tahun']?></td>
                            <td style="text-align:center;"><?=$data_siswa['nominal']?></td>
                            <td style="text-align:center;"><a href="" class="btn btn-inverse-success mdi mdi-pencil" data-toggle="modal" data-target="#update<?php echo $data_siswa['id_spp'];?>"></a> <a href="hapus_spp.php?id_spp=<?=$data_siswa['id_spp']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-inverse-danger mdi mdi-delete"></a>
                            </td>

                            <!-- Modal Update -->
                            <div class="modal fade" id="update<?php echo $data_siswa['id_spp'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div style="background-color: #191c24;" class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Update SPP</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body">
                                  <form class="forms-sample" action="proses_ubah_spp.php" method="post">
                                  <input type="hidden" name="id_spp" class="form-control" id="exampleInputEmail1" value= "<?=$data_siswa['id_spp']?>">
                                    <div class="form-group">
                                      <label for="exampleSelectGender">Angkatan</label>
                                      <select name="id_angkatan" class="form-control" id="exampleSelectGender">
                                        <?php
                                          include "../koneksi.php";
                                          $qry_kelas=mysqli_query($conn,"select * from angkatan");
                                          while($data_kelas=mysqli_fetch_array($qry_kelas)){
                                          if($data_kelas['id_angkatan']==$data_siswa['id_angkatan']){
                                          $selek="selected";
                                          } else {
                                          $selek="";
                                          }
                                          echo '<option value="'.$data_kelas['id_angkatan'].'"
                                          '.$selek.'>'.$data_kelas['angkatan'].'</option>';
                                          }
                                        ?>
                                      </select>
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <input type="number" name="tahun" class="form-control" id="exampleInputEmail1" placeholder="Tahun" value= "<?=$data_siswa['tahun']?>">
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputPassword1">Nominal</label>
                                      <input type="text" name="nominal" class="form-control" id="exampleInputPassword1" placeholder="Nominal" value= "<?=$data_siswa['nominal']?>">
                                    </div>
                        ...
                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div style="background-color: #191c24;" class="modal-content">
                              ...
                              <div class="modal-body">
                              <form class="forms-sample" action="proses_tambah_spp.php" method="post">
                                <div class="form-group">
                                  <label for="exampleSelectGender">Angkatan</label>
                                  <select name="id_angkatan" class="form-control" id="exampleSelectGender">
                                    <?php 
                                ...
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Tahun</label>
                                  <input type="number" name="tahun" class="form-control" id="exampleInputEmail1" placeholder="Tahun">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Nominal</label>
                                  <input type="text" name="nominal" class="form-control" id="exampleInputPassword1" placeholder="Nominal">
                                </div>
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-dark" data-dismiss="modal">Close</button>
                                  <button type="submit" class="btn btn-primary">Submit</button>
